...
#  Program to stop the Python Application Write Client.
#
...
[ "${PWC_IP}" != "${MY_IP}" ] && {
   ...
   echo "   Application Write Client on, and also which IP this"
...
echo ""
echo ""
echo "This program will soft kill the Python Application Write Client."
echo ""
echo ""
...
#
l_pid=`ps -ef | egrep "python3|pyagent" | grep "PythonWriteClient" | awk '{print $2}'`
kill -15 "${l_pid}" 2> /dev/null
   #
sleep 10


echo "Python Application Write Client stopped."
echo ""
echo ""
